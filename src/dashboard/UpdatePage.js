...
var UpdatePage = function () {
    ...
    var _c = (0, react_1.useState)({
        ...
        type: "",
        year: 0,
    }), updateCar = _c[0], setUpdateCar = _c[1];
    var getCardById = function () { return __awaiter(void 0, void 0, void 0, function () {
        var response, dataArray;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get("http://localhost:8000/api/cars/" + id, {
                        headers: {
    ...
    var handleChange = function (e) {
        ...
        setUpdateCar(function (prevCars) {
            var _a;
    ...
    var update = function () { return __awaiter(void 0, void 0, void 0, function () {
        var imageUrl, updateCars, formData, response, dataArray, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    imageUrl = null;
                ...
                case 1:
                    ...
                    _a.label = 2;
                case 2:
                    updateCars = __assign(__assign({}, updateCar), { image: imageUrl });
                ...
                case 3:
                    _a.trys.push([3, 5, , 6]);
                    return [4 /*yield*/, axios_1.default.put("http://localhost:8000/api/cars/" + id, formData, {
                            headers: {
                                Authorization: "Barear " + sessionStorage.getItem("token"),
                            },
                        })];
                case 4:
                    ...
                    react_toastify_1.toast.success("Mobil berhasil diupdate", {
                        position: "top-right",
                        autoClose: 1500,
                    });
                    setTimeout(function () {
